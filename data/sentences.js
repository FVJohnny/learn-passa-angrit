...
const SENTENCE_PACKS_L3 = [
  ...
  {
    id: 's3-directions', icon: '🧭', th: 'ถามทาง', en: 'Asking Directions',
    sentences: [
      { en: 'Turn left at the traffic light', th: 'เลี้ยวซ้ายที่ไฟแดง', extra: ['right', 'stop', 'bridge'], thTiles: ['เลี้ยวซ้าย', 'ที่', 'ไฟแดง'], thExtra: ['เลี้ยวขวา', 'สะพาน'] },
      { en: 'The market is on the right', th: 'ตลาดอยู่ทางขวา', extra: ['left', 'under', 'far'], thTiles: ['ตลาด', 'อยู่', 'ทางขวา'], thExtra: ['ทางซ้าย', 'ไกล'] },
      { en: 'Go straight and turn right at the corner', th: 'ตรงไปแล้วเลี้ยวขวาที่หัวมุม', extra: ['left', 'stop', 'bridge'], thTiles: ['ตรงไป', 'แล้ว', 'เลี้ยวขวา', 'ที่', 'หัวมุม'], thExtra: ['เลี้ยวซ้าย', 'หยุด'] },
      { en: 'The cafe is next to the bank', th: 'ร้านกาแฟอยู่ข้างๆธนาคาร', extra: ['behind', 'school', 'far'], thTiles: ['ร้านกาแฟ', 'อยู่', 'ข้างๆ', 'ธนาคาร'], thExtra: ['ข้างหลัง', 'โรงเรียน'] },
      { en: 'My house is behind the temple', th: 'บ้านฉันอยู่ข้างหลังวัด', extra: ['front', 'school', 'near'], thTiles: ['บ้านฉัน', 'อยู่', 'ข้างหลัง', 'วัด'], thExtra: ['ข้างหน้า', 'โรงเรียน'] },
      { en: 'The cat is under the table', th: 'แมวอยู่ใต้โต๊ะ', extra: ['dog', 'on', 'chair'], thTiles: ['แมว', 'อยู่', 'ใต้', 'โต๊ะ'], thExtra: ['หมา', 'บน'] },
      { en: 'Is the hotel far from here', th: 'โรงแรมไกลจากที่นี่ไหม', extra: ['near', 'bank', 'there'], thTiles: ['โรงแรม', 'ไกล', 'จาก', 'ที่นี่', 'ไหม'], thExtra: ['ใกล้', 'ที่นั่น'] },
      { en: 'The school is opposite the park', th: 'โรงเรียนอยู่ตรงข้ามสวน', extra: ['inside', 'market', 'behind'], thTiles: ['โรงเรียน', 'อยู่', 'ตรงข้าม', 'สวน'], thExtra: ['ข้างใน', 'ตลาด'] },
      { en: 'Your phone is on the bed', th: 'โทรศัพท์ของคุณอยู่บนเตียง', extra: ['under', 'bag', 'chair'], thTiles: ['โทรศัพท์', 'ของคุณ', 'อยู่', 'บน', 'เตียง'], thExtra: ['ใต้', 'กระเป๋า'] },
      { en: 'Wait for me in front of the shop', th: 'รอฉันข้างหน้าร้าน', extra: ['behind', 'run', 'him'], thTiles: ['รอ', 'ฉัน', 'ข้างหน้า', 'ร้าน'], thExtra: ['ข้างหลัง', 'วิ่ง'] },
    ],
  },
  {
    id: 's3-plans', icon: '📅', th: 'แผนและอนาคต', en: 'Plans & The Future',
    sentences: [
      { en: 'We will go to the beach in April', th: 'เราจะไปทะเลเดือนเมษายน', extra: ['mountain', 'May', 'went'], thTiles: ['เรา', 'จะ', 'ไป', 'ทะเล', 'เดือน', 'เมษายน'], thExtra: ['ภูเขา', 'พฤษภาคม'] },
      { en: 'My birthday is in December', th: 'วันเกิดฉันเดือนธันวาคม', extra: ['holiday', 'January', 'was'], thTiles: ['วันเกิดฉัน', 'เดือน', 'ธันวาคม'], thExtra: ['วันหยุด', 'มกราคม'] },
      { en: 'I will see my family next month', th: 'ฉันจะไปหาครอบครัวเดือนหน้า', extra: ['friend', 'week', 'saw'], thTiles: ['ฉัน', 'จะ', 'ไปหา', 'ครอบครัว', 'เดือนหน้า'], thExtra: ['เพื่อน', 'สัปดาห์หน้า'] },
      { en: 'It rains a lot in September', th: 'เดือนกันยายนฝนตกเยอะ', extra: ['snows', 'March', 'little'], thTiles: ['เดือน', 'กันยายน', 'ฝนตก', 'เยอะ'], thExtra: ['มีนาคม', 'นิดหน่อย'] },
      { en: 'Songkran is in April every year', th: 'สงกรานต์อยู่เดือนเมษายนทุกปี', extra: ['December', 'week', 'month'], thTiles: ['สงกรานต์', 'อยู่', 'เดือน', 'เมษายน', 'ทุกปี'], thExtra: ['ธันวาคม', 'ทุกเดือน'] },
      { en: 'What will you do next weekend', th: 'สุดสัปดาห์หน้าคุณจะทำอะไร', extra: ['yesterday', 'where', 'did'], thTiles: ['สุดสัปดาห์หน้า', 'คุณ', 'จะ', 'ทำ', 'อะไร'], thExtra: ['เมื่อวาน', 'ที่ไหน'] },
      { en: 'We are going to travel in November', th: 'เราจะไปเที่ยวเดือนพฤศจิกายน', extra: ['June', 'work', 'went'], thTiles: ['เรา', 'จะ', 'ไปเที่ยว', 'เดือน', 'พฤศจิกายน'], thExtra: ['มิถุนายน', 'ทำงาน'] },
      { en: 'The weather is very hot in March', th: 'เดือนมีนาคมอากาศร้อนมาก', extra: ['cold', 'August', 'rainy'], thTiles: ['เดือน', 'มีนาคม', 'อากาศ', 'ร้อน', 'มาก'], thExtra: ['หนาว', 'สิงหาคม'] },
      { en: 'I want to learn English this year', th: 'ปีนี้ฉันอยากเรียนภาษาอังกฤษ', extra: ['Thai', 'teach', 'month'], thTiles: ['ปีนี้', 'ฉัน', 'อยาก', 'เรียน', 'ภาษาอังกฤษ'], thExtra: ['ภาษาไทย', 'เดือนนี้'] },
      { en: 'We will celebrate New Year together in January', th: 'เราจะฉลองปีใหม่ด้วยกันเดือนมกราคม', extra: ['birthday', 'February', 'alone'], thTiles: ['เรา', 'จะ', 'ฉลอง', 'ปีใหม่', 'ด้วยกัน', 'เดือน', 'มกราคม'], thExtra: ['วันเกิด', 'กุมภาพันธ์'] },
    ],
  },
];
