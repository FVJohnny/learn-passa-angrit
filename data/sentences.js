...
const SENTENCE_PACKS = [
  ...
  },
  {
    ...
    sentences: [
      ...
      { en: 'I do not like coffee', th: 'ฉันไม่ชอบกาแฟ', extra: ['tea', 'want'] },
  ...
  },
  {
    ...
    sentences: [
      ...
      { en: 'I do not have money', th: 'ฉันไม่มีเงิน', extra: ['want', 'time'] },
  ...
  },
  {
    ...
    sentences: [
      ...
      { en: 'I do not understand', th: 'ฉันไม่เข้าใจ', extra: ['know', 'you'] },
